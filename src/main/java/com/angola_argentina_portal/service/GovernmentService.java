...
public class GovernmentService {
    ...
    public Government save(Government government) throws IOException {

        FileImage acessImage = new FileImage();
        Assistant assistant = new Assistant();
        String newNameFile = "default.png"; // Default image nam

        if (government.getImageGovernmentUtil() != null) {
            newNameFile = "0" + assistant.novoNome(government.getImageGovernmentUtil().getContentType());
            acessImage.salvarArquivo(government.getImageGovernmentUtil(), "government_entities_images", newNameFile);
        } else {
